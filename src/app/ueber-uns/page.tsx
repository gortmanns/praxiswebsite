                ...
                <Card>
                    <CardContent className="space-y-6 p-8">
                        ...
                        <ul className="list-disc space-y-4 pl-6">
                            ...
                            <li>Die gesamte Praxis-IT inklusive der Telefonanlage wurden komplett erneuert und auf den neuesten Stand der Technik gebracht.</li>
                            <li>Im neuen Praxisbereich sind 2 neue Sprechzimmer entstanden und ein neuer Empfangsbereich wurde gestaltet. Der alte Empfang dient dann nur noch der Medikamentenabgabe.</li>
                            ...
                            <li>Damit sich der ganze Aufwand auch lohnt und der Umbau zu einem Praxiszentrum auch diesen Namen rechtfertigt wurden Kooperationen mit diversen Fachspezialisten geschlossen, die jetzt regelmässig Termine bei uns im Praxiszentrum anbieten, so dass wir unseren Patienten den Weg in die Stadt Bern vielfach ersparen können.</li>
                            <li>Eine Ernährungsberaterin führt regelmässig Termine bei uns in den Räumlichkeiten durch, so dass auch hierfür die Wege für unsere Patienten nun kurz sind.</li>
                        ...
                        <ul className="list-disc space-y-4 pl-6">
                            ...
                            <li>Wir suchen ständig nach weiteren Spezialisten, die gerne zur Verbesserung der medizinischen Versorgung in Hintekappelen beitragen möchte und Termine bei uns im PRAXISZENTRUM IM RING anbieten.</li>
                            <li>Wir suchen noch nach weiteren Hausärztinnen und Hausärzten, die in Voll- oder Teilzeit hier arbeiten möchte.</li>
                            <li>Sobald dies von der dann grösser werdenden Personaldecke aus möglich ist, werden wir den neugeschaffenen Empfangsbereich in Betrieb nehmen.</li>
                        </ul>

                        <h3 className="pt-4 font-headline text-2xl font-bold text-primary">Was ist unsere Vision?</h3>
                        <ul className="list-disc space-y-4 pl-6">
                            <li>Langfristig möchten wir so viele Hausärzte für die Arbeit hier im Praxiszentrum gewinnen, dass wir Montag bis Samstag von 8-20 Uhr durchgehend öffnen können.</li>
