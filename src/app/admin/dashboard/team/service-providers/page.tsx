...
const initialServiceProviderState: Omit<ServiceProvider, 'id' | 'order' | 'createdAt'> = {
    ...
    role2: "",
    imageUrl: "",
    backsideContent: "<p>Zum Bearbeiten klicken</p>",
    languages: ['de'],
    hidden: false,
    fullWidth: false,
};
                             ...
                             {items.map((item, index) => (
                                <div key={item.id} className="flex flex-col items-center gap-4">
                                     <div className={cn(
                                        ...
                                        <EditableServiceProviderCard provider={item} isBeingEdited={isEditing && editingCardId === item.id} />
                                    </div>
                            ...
                            <div className="mt-8 space-y-8">
                                {Array.from({ length: 2 }).map((_, index) => (
                                    <div key={index} className="flex flex-col items-center space-y-4">
                                        <Skeleton className="w-full max-w-[500px] aspect-[2/3]" />
