...
export const EditableServiceProviderCard: React.FC<EditableServiceProviderCardProps> = ({ serviceProvider, onCardClick, isBeingEdited, showBackside = false, showBacksideOnly = false }) => {
         ...
         return (
            ...
            >
                <div className="absolute inset-0 flex flex-col items-center justify-start overflow-auto bg-accent/95 text-left text-background">
                    <CodeRenderer html={serviceProvider.backSideCode} />
                </div>
                 {isBeingEdited && (
