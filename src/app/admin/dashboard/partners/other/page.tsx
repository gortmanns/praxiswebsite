...
function OtherPartnersPageManager() {
    const collectionName = "otherPartners";
    const pageTitle = "Sonstige Partner verwalten";
    const pageDescription = "Verwalten Sie die auf der Startseite angezeigten Karten der sonstigen Partner.";
    const entityName = "Sonstiger Partner";
    ...
    const [editorCardState, setEditorCardState] = useState<CardData>({ ...initialOtherPartnerState, id: '', order: 0 } as CardData);
    ...
    const handleCreateNew = () => {
        ...
        setEditorCardState({ ...initialOtherPartnerState, id: '' } as CardData);
    };
           ...
           <div className="grid h-full w-full grid-cols-8 items-center gap-x-4">
                <div className="col-start-6 col-span-2 flex flex-col items-center justify-center">
                 ...
                 <div className="col-start-8 col-span-1 flex h-full flex-col items-center justify-center">
                      {/* Intentionally left blank, sliders are in the editor component */}
                </div>
           </div>
        </div>
    ) : null;
