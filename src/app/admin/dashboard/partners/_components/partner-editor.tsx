                    ...
                    <div className="col-span-2 flex flex-col items-center py-4">
                        <div className='w-full max-w-xs space-y-4'>
                            ...
                            <div className="space-y-2">
                                ...
                                <Slider id="logoScale" value={[cardData.logoScale || 100]} onValueChange={(value) => handleSliderChange('logoScale', value)} max={200} step={1} className="w-full [&_[role=slider]]:bg-white [&>span:first-child>span]:bg-muted" />
                            </div>
                        </div>
