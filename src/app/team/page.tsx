          ...
          <div className="mx-auto mt-16 max-w-5xl">
            ...
            >
              <Card className="absolute inset-0 overflow-hidden">
                ...
                <ul className="space-y-1.5 text-[0.8rem] leading-snug">
                    ...
                    <li className="font-bold text-primary">
                      ...
                      Australien
                      <div className="mt-1 pl-4 text-[0.7rem] leading-snug text-background/80">
                    ...
                    <li className="mt-2 font-bold text-primary">
                      ...
                      <ul className="mt-1 list-disc space-y-px pl-9 text-[0.7rem] leading-snug text-background/80">
                  ...
                  <p className="mt-2 text-[0.7rem] font-bold text-primary">
