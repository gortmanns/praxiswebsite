      ...
      <main className="flex-1">
        <div className="container py-16 sm:py-24">
          <div className="mx-auto max-w-5xl space-y-16">
            ...
            <div className="mx-auto flex w-full max-w-[1000px] justify-center p-2">
              <OrtmannsCard />
            </div>
            <div className="mx-auto flex w-full max-w-[1000px] justify-center p-2" id="schemmer">
              <SchemmerCard />
            </div>
            ...
            <div className="mx-auto flex w-full max-w-[1000px] justify-center p-2" id="slezak">
              <SlezakCard />
            </div>
