        ...
        >
            <Card className="absolute inset-0 overflow-hidden debug-outline">
                ...
                <div className="absolute inset-0 flex flex-col items-start justify-center overflow-auto bg-accent p-6 text-left text-background opacity-0 transition-opacity duration-300 group-hover:opacity-100 debug-outline">
                    <ul className="space-y-1.5 text-[clamp(0.8rem,2.5cqw,1.2rem)] leading-tight debug-outline">
                        ...
                        Australien
                        <div className="mt-1 pl-4 text-[clamp(0.7rem,2.3cqw,1rem)] leading-snug text-background/80 debug-outline">
                        ...
                        <ul className="mt-1 list-disc space-y-px pl-9 text-[clamp(0.7rem,2.3cqw,1rem)] leading-snug text-background/80 debug-outline">
                    ...
                    <p className="mt-2 text-[clamp(0.7rem,2.3cqw,1rem)] font-bold text-primary">
                        Wissenschaftlicher Mitarbeiter an der Universität Zürich /
                        USZ (Abteilung für Pneumologie)
                    </p>
                    <p className="text-[clamp(0.7rem,2.3cqw,1rem)] font-bold text-primary">
