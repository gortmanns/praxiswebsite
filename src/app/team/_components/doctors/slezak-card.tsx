                        ...
                        <div class="flex-grow flex flex-col justify-center ml-6 h-full relative">
                            <div>
                                ...
                                <div class="mt-6 flex items-center justify-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 60" class="h-auto" style="height: 6.9rem;" aria-label="Dr. med. Agnieszka Slezak - Fachärztin für Neurologie Logo">
                                        <rect width="210" height="60" fill="#358392" rx="6"></rect>
