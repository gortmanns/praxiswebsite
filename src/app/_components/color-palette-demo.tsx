...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Secondary", className: "bg-secondary text-secondary-foreground", value: "209 18% 64%" },
    { name: "Secondary FG", className: "bg-secondary-foreground text-secondary", value: "0 0% 98%", border: true },
    ...
    { name: "Muted", className: "bg-muted text-muted-foreground", value: "210 20% 98%" },
    { name: "Muted FG", className: "bg-muted-foreground text-muted", value: "216 10% 45%" },
    { name: "Accent", className: "bg-accent text-accent-foreground", value: "210 20% 94%" },
    { name: "Accent FG", className: "bg-accent-foreground text-accent", value: "216 15% 25%" },
    { name: "Destructive", className: "bg-destructive text-destructive-foreground", value: "0 84.2% 60.2%" },
    { name: "Border", className: "bg-border text-foreground", value: "214 20% 85%" },
    { name: "Input", className: "bg-input text-foreground", value: "214 20% 85%" },
