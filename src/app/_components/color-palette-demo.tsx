...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Muted", className: "text-foreground", value: "220 14% 96%", hsl: { bg: "hsl(220 14% 96%)", fg: "hsl(220 9% 40%)" } },
    { name: "Muted FG", className: "text-background", value: "220 9% 40%", hsl: { bg: "hsl(220 9% 40%)", fg: "hsl(220 14% 96%)" } },
    { name: "Accent", className: "text-foreground", value: "220 9% 40%", hsl: { bg: "hsl(220 9% 40%)", fg: "hsl(197 100% 47%)" } },
    { name: "Accent FG", className: "text-background", value: "197 100% 47%", hsl: { bg: "hsl(197 100% 47%)", fg: "hsl(220 9% 40%)" } },
