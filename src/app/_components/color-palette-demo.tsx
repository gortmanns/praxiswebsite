...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Accent", className: "text-foreground", value: "216 10% 25%", hsl: { bg: "hsl(216 10% 25%)", fg: "hsl(197 100% 47%)" } },
    { name: "Accent FG", className: "text-background", value: "197 100% 47%", hsl: { bg: "hsl(197 100% 47%)", fg: "hsl(216 10% 25%)" } },
