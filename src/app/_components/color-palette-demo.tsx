...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Secondary", className: "bg-secondary text-secondary-foreground", value: "220 9% 46%" },
    ...
    { name: "Card", className: "bg-card text-card-foreground", value: "220 13% 96%" },
    { name: "Card FG", className: "bg-card-foreground text-card", value: "220 9% 46%" },
    { name: "Muted", className: "bg-muted text-muted-foreground", value: "210 20% 98%", border: true },
    { name: "Muted FG", className: "bg-muted-foreground text-muted", value: "215 28% 17%" },
