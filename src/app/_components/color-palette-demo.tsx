...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Secondary FG", className: "bg-secondary-foreground text-secondary", value: "215 27.9% 16.9%" },
    ...
    { name: "Card FG", className: "bg-card-foreground text-card", value: "224 71.4% 4.1%" },
    { name: "Muted", className: "bg-muted text-muted-foreground", value: "215 25% 95.1%" },
    { name: "Muted FG", className: "bg-muted-foreground text-muted", value: "215 27.9% 46.9%" },
    { name: "Accent", className: "bg-accent text-accent-foreground", value: "215 25% 95.1%" },
    { name: "Accent FG", className: "bg-accent-foreground text-accent", value: "215 27.9% 16.9%" },
