...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Secondary", className: "bg-secondary text-secondary-foreground", value: "216 12% 84%" },
    { name: "Secondary FG", className: "bg-secondary-foreground text-secondary", value: "224 71% 4%", border: true },
    ...
    { name: "Border", className: "bg-border text-foreground", value: "220 13% 91%" },
    { name: "Input", className: "bg-input text-foreground", value: "220 13% 91%" },
