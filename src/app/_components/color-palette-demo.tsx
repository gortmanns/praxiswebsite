...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Secondary", className: "bg-secondary text-secondary-foreground", value: "215 15% 50%" },
    ...
    { name: "Accent", className: "bg-accent text-accent-foreground", value: "220 14% 96%" },
    { name: "Accent FG", className: "bg-accent-foreground text-accent", value: "220 9% 46%" },
