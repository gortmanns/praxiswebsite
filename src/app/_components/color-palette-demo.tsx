...
export function ColorPaletteDemo() {
  const colors = [
    ...
    { name: "Secondary", className: "bg-secondary text-secondary-foreground", value: "215 15% 45%" },
    ...
    { name: "Muted", className: "bg-muted text-muted-foreground", value: "210 40% 96.1%", border: true },
