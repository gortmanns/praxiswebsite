...
const ZahnradIcon = () => (
  ...
  >
    <path
      d="M48.2,35.4c-0.2-1-0.5-2-0.8-3l-2.2-0.4c-0.6-2.6-1.5-5-2.8-7.3l1.1-2c0.9-1.8,1.2-3.8,0.9-5.7 c-0.4-1.9-1.3-3.6-2.7-4.9l-1.6-1.6c-1.3-1.3-3-2.2-4.9-2.7c-1.9-0.4-3.9-0.1-5.7,0.9l-2,1.1c-2.3-1.3-4.8-2.2-7.3-2.8 l-0.4-2.2c-0.5-2.5-1.8-4.7-3.8-6.1l-2.2-1.6c-2.3-1.7-5.3-2-7.9-0.8l-2.2,1c-2.5,1.1-4.5,2.9-5.7,5.2l-1,2.2 c-2.6,0.6-5,1.5-7.3,2.8l-2-1.1c-1.8-0.9-3.8-1.2-5.7-0.9c-1.9,0.4-3.6,1.3-4.9,2.7l-1.6,1.6c-1.3,1.3-2.2,3-2.7,4.9 c-0.4,1.9-0.1,3.9,0.9,5.7l1.1,2c-1.3,2.3-2.2,4.8-2.8,7.3l-2.2,0.4c-2.5,0.5-4.7,1.8-6.1,3.8l-1.6,2.2 c-1.7,2.3-2,5.3-0.8,7.9l1,2.2c1.1,2.5,2.9,4.5,5.2,5.7l2.2,1c2.6,0.6,5,1.5,7.3,2.8l-1.1,2c-0.9,1.8-1.2,3.8-0.9,5.7 c0.4,1.9,1.3,3.6,2.7,4.9l1.6,1.6c1.3,1.3,3,2.2,4.9,2.7c1.9,0.4,3.9,0.1,5.7-0.9l2-1.1c2.3,1.3,4.8,2.2,7.3,2.8l0.4,2.2 c0.5,2.5,1.8,4.7,3.8,6.1l2.2,1.6c2.3,1.7,5.3,2,7.9,0.8l2.2-1c2.5-1.1,4.5-2.9,5.7-5.2l1-2.2c2.6-0.6,5-1.5,7.3-2.8l2,1.1 c1.8,0.9,3.8,1.2,5.7,0.9c1.9-0.4,3.6-1.3,4.9-2.7l1.6-1.6c1.3-1.3,2.2-3,2.7-4.9c0.4-1.9,0.1-3.9-0.9-5.7l-1.1-2 c1.3-2.3,2.2-4.8,2.8-7.3l2.2-0.4c2.5-0.5,4.7-1.8,6.1-3.8l1.6-2.2C50.2,40.7,49.8,37.7,48.2,35.4z M28,38.8 c-5.9,0-10.8-4.8-10.8-10.8s4.8-10.8,10.8-10.8s10.8,4.8,10.8,10.8S33.9,38.8,28,38.8z"
      fill="#00aaef"
    />
    <text
      x="65"
              ...
              <Card className="flex min-h-[144px] items-center p-6 transition-all group-hover:-translate-y-1 group-hover:shadow-lg">
                <CardContent className="flex w-full items-center justify-center p-0">
                  {partner.isSvg ? (
                    ...
                    <div className="flex h-[80px] w-[280px] items-center justify-center">
                      <Image
                        src={partner.logoUrl!}
