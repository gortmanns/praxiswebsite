...
function FaPillsIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg 
      ...
      fill="currentColor"
      {...props}>
      <path d="M414.2 360.8c-2.3-2.3-4.8-4.3-7.4-6.2L304.4 457c-2.3 2.3-4.3 4.8-6.2 7.4c-23.9 23.9-62.7 23.9-86.6 0l-42.8-42.8c-23.9-23.9-23.9-62.7 0-86.6l129.4-129.4c2.3 2.3 4.8 4.3 7.4 6.2L408 269.4c2.3-2.3 4.3-4.8 6.2-7.4c23.9-23.9 62.7-23.9 86.6 0l42.8 42.8c23.9 23.9 23.9 62.7 0 86.6L414.2 360.8zM224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128z"/>
    </svg>
  );
}
