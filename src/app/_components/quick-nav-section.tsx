        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {navItems.map((item) => (
            ...
            >
              ...
              <div
                className="absolute flex h-full w-full flex-col items-center justify-center gap-4 rounded-lg bg-green-900 p-6 text-primary-foreground transition-transform duration-500"
              >
